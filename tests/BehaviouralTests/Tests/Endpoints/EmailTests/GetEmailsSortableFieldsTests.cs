...
public class GetEmailsSortableFieldsTests : TestBase<TestFixture>
{
    ...
    public GetEmailsSortableFieldsTests(TestFixture testFixture)
    {
    ...
    [Fact]
    public async Task GetEmailsSortableFields_NotLoggedIn_ReturnsUnauthorized()
    {
        // Act
        var (httpResponseMessage, _) = await _testFixture.Client.GETAsync<GetEmailsSortableFields, QueryFieldsResponseDto>();
    ...
    [Fact]
    public async Task GetEmailsSortableFields_ExpiredAccessToken_ReturnsUnauthorized()
    {
        // Arrange
    ...
    [Fact]
    public async Task GetEmailsSortableFields_UserNoLongerExists_ReturnsUnauthorized()
    {
        // Arrange
    ...
    [Fact]
    public async Task GetEmailsSortableFields_UserNotAdmin_ReturnsForbidden()
    {
        // Arrange
        var user = FakeUser.CreateValid(_fixture) with
        {
    ...
    [Fact]
    public async Task GetEmailsSortableFields_GivenValidRequest_ReturnsOk()
    {
        // Arrange
        var user = FakeUser.CreateValid(_fixture) with
        {
        ...
        // Act
        _testFixture.Client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", accessToken);
        var (httpResponseMessage, queryFieldsResponse) = await _testFixture.Client.GETAsync<GetEmailsSortableFields, QueryFieldsResponseDto>();
