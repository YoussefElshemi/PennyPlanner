...
namespace UnitTests.Tests.Presentation.WebApi.Validators.UserManagement;
...
public class UserManagementUpdateUserRequestDtoValidatorTests : BaseTestClass
{
    ...
    {
        _validator = new UserManagementUpdateUserRequestDtoValidator(_mockUserRepository.Object);
    }
